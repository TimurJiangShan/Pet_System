...
<div class="row">
  <div class="panel panel-default">
    <div class="panel-heading"><h4 style="margin-top: 0; margin-bottom: 0px;">
        ${tagName}
        <small>There are ${pageByTag.totalRow} topics</small>
      </h4></div>
    ...
    <div class="media">
      ...
      <div class="media-body">
        ...
        <p class="gray">
          ...
          <!-- <span>•</span> -->
          <%-- <span>The last reply came from <a href="/user/${item.lastReplyAuthor}">${item.lastReplyAuthor}</a></span> --%>
          </c:if>
        </p>
        </div>
      </div>
...
<script type="text/javascript">
	...
	var count = ${pageByTag.totalRow};//Total amount of data
