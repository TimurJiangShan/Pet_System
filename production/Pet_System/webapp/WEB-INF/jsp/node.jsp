        ...
        <div class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-3 hidden-sm hidden-xs">
                        ...
                        <div class="box box-warning" id="session">
                                ...
                                <div class="media">
                                    ...
                                    <div style="margin-top: 15px;">
                                        <a href="/topic/create" style="font-size: 14px;">
                                            <button class="btn btn-warning">Post a post</button>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="panel-footer" style="background-color: white">
								...
								<span class="col-md-6"><a href="/notification/list"><span
                                        id="n_count">${countNotReadNotice}</span> unread message(s)</a></span> <span
                    ...
                    <!-- Popular node -->
                    <div class="box box-warning">
                        <div class="box-header with-border"><b>Popular node</b></div>
                        <div class="box-body">
                            <div class="row">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <p>number of topics:${countAllTopic}</p>
