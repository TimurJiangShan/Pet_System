...
<html>
<head>
  <title>Pet Information Service Platform-Search Results</title>
          ...
          <div class="media" id="topic">
            ...
            <div class="media-body">
			  ...
			  <c:if test="${not empty item.nodeTitle}">
                ...
                <!-- comment -->
                <!-- <span class="hidden-sm hidden-xs">•</span> -->
                <%-- <span class="hidden-sm hidden-xs"><a href="/topic/41">${item.replyCount}comment(s)</a></span> --%>
                <span>•</span>
                <span><fmt:formatDate type="date" 
                  ...
                  <!-- Last user who responded -->
                  <%-- <c:if test="${item.lastReplyAuthor != null}">
                  <span>•</span>
                  <span>The final reply comes from <a href="/user/${item.lastReplyAuthor}">${item.lastReplyAuthor}</a></span>
                  </c:if> --%>
...
<script type="text/javascript">
  ...
  var count = ${pageLike.totalRow};//Total amount of data
  var limit = ${pageLike.pageSize};//Number of items displayed per page
